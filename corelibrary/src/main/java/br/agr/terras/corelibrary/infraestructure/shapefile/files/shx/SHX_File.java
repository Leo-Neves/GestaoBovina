...
package br.agr.terras.corelibrary.infraestructure.shapefile.files.shx;

import java.io.File;
import java.nio.ByteOrder;
import java.util.Locale;

import br.agr.terras.corelibrary.infraestructure.shapefile.files.ShapeFileReader;
import br.agr.terras.corelibrary.infraestructure.shapefile.files.shp.SHP_Header;
...
public class SHX_File extends ShapeFileReader{
  ...
  public static boolean LOG_INFO = ShapeFile.log;
  /** enable/disable logging of the header, while loading. */
  public static boolean LOG_ONLOAD_HEADER = ShapeFile.log;
  /** enable/disable logging of the content, while loading. */
  public static boolean LOG_ONLOAD_CONTENT = ShapeFile.log;
