...
package br.agr.terras.corelibrary.infraestructure.shapefile.files.shp.shapeTypes;
...
public class ShpPolygon extends ShpShape{
  ...
  public void print(){
    ...
    System.out.printf(Locale.ENGLISH, "  |     points                 = %s\n", Arrays.deepToString(getPointsAs3DArray()));
