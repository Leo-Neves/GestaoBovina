/**
 * br.agr.terras.corelibrary.infraestructure.shapefileReader.
 * 
...
package br.agr.terras.corelibrary.infraestructure.shapefile.shapeFile;


import java.io.File;
import java.util.ArrayList;

import br.agr.terras.corelibrary.infraestructure.shapefile.files.dbf.DBF_Field;
import br.agr.terras.corelibrary.infraestructure.shapefile.files.dbf.DBF_File;
import br.agr.terras.corelibrary.infraestructure.shapefile.files.shp.SHP_File;
import br.agr.terras.corelibrary.infraestructure.shapefile.files.shp.shapeTypes.ShpShape;
import br.agr.terras.corelibrary.infraestructure.shapefile.files.shx.SHX_File;
...
public class ShapeFile {
  ...
  // library info
  public final static String _LIBRARY_NAME      = "br.agr.terras.corelibrary.infraestructure.shapefileReader";
   ...
   * @throws Exception
   */
  public ShapeFile(String path) throws Exception{

    // MAIN DIRECTORY
    File dir = new File(path).getParentFile();
    String filename = new File(path).getName().substring(0, new File(path).getName().lastIndexOf('.'));
  ...
  /**
   * same as:
   * {@link br.agr.terras.corelibrary.infraestructure.shapefile.files.shp.SHP_Header#getBoundingBox()}
