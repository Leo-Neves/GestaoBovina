...
public class AboutPage {
    ...
    public void show(boolean visibilidade) {
        mView.setVisibility(visibilidade ? View.VISIBLE : View.GONE);
    }
    ...
    public AboutPage addEmail(String email) {
        ...
        emailElement.setColor(ContextCompat.getColor(mContext, R.color.about_github_color));
