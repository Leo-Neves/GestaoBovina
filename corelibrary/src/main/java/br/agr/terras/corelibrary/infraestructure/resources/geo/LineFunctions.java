...
{
	private final PointFunctions _start;
	private final PointFunctions _end;
	private double _a = Double.NaN;
	private double _b = Double.NaN;
	private boolean _vertical = false;


	public LineFunctions(PointFunctions start, PointFunctions end)
	{
		_start = start;
		_end = end;
	 ...
	 */
	public boolean isInside(PointFunctions point)
	{
	 ...
	 */
	public PointFunctions getStart()
	{
		return _start;
	}
