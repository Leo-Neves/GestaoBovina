 ...
 */
public class PolygonsCalculus {
    private final static String LOG_TAG = "PolygonCalculus";

    private static final double EARTH_RADIUS = 6371000;// meters

    public static double calculateAreaOfInSquareMeters(final List<Location> locations) {
        if (locations.size() < 3) {
            return 0;
        }
