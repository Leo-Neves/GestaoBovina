...
public class WeeksAdapter extends RecyclerView.Adapter<WeeksAdapter.WeekViewHolder> {
    ...
    private int mDayTextColor, mPastDayTextColor, mCurrentDayColor, mMonthTextColor;

    // region Constructor

    public WeeksAdapter(Context context, Calendar today, int dayTextColor, int currentDayTextColor, int pastDayTextColor, int mMonthTextColor) {
        this.mToday = today;
        this.mContext = context;
        this.mDayTextColor = dayTextColor;
        this.mCurrentDayColor = currentDayTextColor;
        this.mPastDayTextColor = pastDayTextColor;
        this.mMonthTextColor = mMonthTextColor;
    }
    ...
    public class WeekViewHolder extends RecyclerView.ViewHolder {
        ...
        public WeekViewHolder(View itemView) {
            ...
            mTxtMonth.setTextColor(mMonthTextColor);
