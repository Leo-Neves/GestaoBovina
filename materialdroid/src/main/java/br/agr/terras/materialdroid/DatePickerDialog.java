...
import br.agr.terras.materialdroid.utils.datepicker.HapticFeedbackController;
import br.agr.terras.materialdroid.utils.datepicker.TypefaceHelper;
import br.agr.terras.materialdroid.utils.datepicker.Utils;
import br.agr.terras.materialdroid.utils.datepicker.date.AccessibleDateAnimator;
import br.agr.terras.materialdroid.utils.datepicker.date.DatePickerController;
import br.agr.terras.materialdroid.utils.datepicker.date.DayPickerView;
import br.agr.terras.materialdroid.utils.datepicker.date.MonthAdapter;
import br.agr.terras.materialdroid.utils.datepicker.date.SimpleDayPickerView;
import br.agr.terras.materialdroid.utils.datepicker.date.YearPickerView;
...
public class DatePickerDialog extends DialogFragment implements
    ...
    private static final String KEY_ONLY_YEAR = "only_year";
    ...
    private boolean showOnlyYear = false;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState != null) {
            ...
            showOnlyYear = savedInstanceState.getBoolean(KEY_ONLY_YEAR);
        }
    }
    ...
    public void onSaveInstanceState(@NonNull Bundle outState) {
        ...
        outState.putBoolean(KEY_ONLY_YEAR, showOnlyYear);
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        eraseButton.setTypeface(TypefaceHelper.get(activity, "Roboto-Medium"));
        ...
        eraseButton.setTextColor(mAccentColor);
        ...
        mMonthAndDayView.setVisibility(showOnlyYear ? View.GONE : View.VISIBLE);
    ...
    /**
     * Set whether the year picker cannot be changed to month ad day picker
     *
     * @param onlyYearPicker boolean
     */
    public void showOnlyYearPicker(boolean onlyYearPicker) {
        showOnlyYear = onlyYearPicker;
    }
    ...
    public void notifyOnDateErased() {
        if (mCallBack != null) {
            mCallBack.onDateErased();
