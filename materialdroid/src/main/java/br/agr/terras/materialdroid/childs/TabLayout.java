...
import br.agr.terras.materialdroid.utils.TintManager;
...
public class TabLayout extends HorizontalScrollView {
    ...
    /**
     * Fixed tabs display all tabs concurrently and are best used com content that benefits from
    ...
    /**
     * Returns the number of tabs currently registered com the action bar.
     *
     * @return Tab count
     */
     ...
     * com content that benefits from quick pivots between tabs.</li>
     * <li>{@link #MODE_SCROLLABLE}: Scrollable tabs display a subset of tabs at any given moment,
     * and can contain longer tab labels and a larger number of tabs. They are best used for
     * browsing contexts in touch interfaces when users don’t need to directly compare the tab
     * labels. This mode is commonly used com a {@link ViewPager}.</li>
     * </ul>
     *
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if (mMode == MODE_FIXED && getChildCount() == 1) {
            ...
            if (child.getMeasuredWidth() > width) {
                // If the child is wider than us, re-measure it com a widthSpec set to exact our
                // measure width
    ...
    public static final class Tab {
        ...
        /**
         * Return the icon associated com this tab.
         *
    ...
    private class SlidingTabStrip extends LinearLayout {
        ...
        protected void onMeasure(final int widthMeasureSpec, final int heightMeasureSpec) {
            ...
            if (MeasureSpec.getMode(widthMeasureSpec) != MeasureSpec.EXACTLY) {
                // HorizontalScrollView will first measure use com UNSPECIFIED, and then com
            ...
            if (mMode == MODE_FIXED && mTabGravity == GRAVITY_CENTER) {
                ...
                if (largestTabWidth <= 0) {
                    // If we don't have a largest child yet, skip until the proxima measure pass
                    return;
                }
