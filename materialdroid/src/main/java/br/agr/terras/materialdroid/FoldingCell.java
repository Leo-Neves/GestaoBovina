...
import br.agr.terras.materialdroid.animations.AnimationEndListener;
import br.agr.terras.materialdroid.animations.FoldAnimation;
import br.agr.terras.materialdroid.animations.HeightAnimation;
import br.agr.terras.materialdroid.childs.FoldingCellView;

/**
 * Created by leo on 23/05/16.
 * Rules:
 *  - Use exactaly two FrameLayout childreen com 'wrap_content'on height
 *  - The first childreen is unfoldeld view, and need to be at least 2x higher than second childreen
 *  - The second one is the title view, or folded view
 *  - Inside these two childreen, set 'clipChildreen' and 'clipToPadding' to 'false' on xml android settings
 *  - Add a OnClickListener to FoldingCell view to toggle animation using this:  'fc.toggle(false)'
 */
public class FoldingCell extends RelativeLayout {
    ...
    /**
     * Initializes folding cell programmatically com custom settings
     *
    ...
    /**
     * Unfold cell com (or without) animation
     *
    ...
    /**
     * Fold cell com (or without) animation
     *
     * @param skipAnimation if true - change state of cell instantly without animation
     */
    ...
    /**
     * Return status of folded or unfolded
     */
    ...
    /**
     * Create and prepare list of FoldingCellViews com different bitmap parts for fold animation
     *
     * @param titleViewBitmap   bitmap from title view
     * @param contentViewBitmap bitmap from content view
     * @return list of FoldingCellViews com bitmap parts
     */
    ...
    /**
     * Calculate heights for animation parts com some logic
    ...
    protected ArrayList<Integer> calculateHeightsForAnimationParts(int titleViewHeight, int contentViewHeight, int additionalFlipsCount) {
        ...
        if (additionalFlipsCount != 0) {
            ...
            // 2 - additional parts count isn't specified or 0 - divide remained space to parts com title view size
     ...
     * @return ImageView com selected height and default background color
     */
     ...
     * @return ImageView com selected bitmap
     */
    ...
    /**
     * Create bitmap from specified View com specified com
     *
     ...
     *
     * @param animationList   collection com animations
     ...
     *
     * @param foldingCellElements           ordered list com animation parts from top to bottom
    ...
    /**
     * Initialize folding cell com parameters from attribute
     *
    ...
    protected void initializeFromAttributes(Context context, AttributeSet attrs) {
        ...
        try {
            this.mAnimationDuration = array.getInt(R.styleable.FoldingCell_fc_animationDuration, DEF_ANIMATION_DURATION);
            this.mBackSideColor = array.getColor(R.styleable.FoldingCell_fc_backSideColor, DEF_BACK_SIDE_COLOR);
            this.mAdditionalFlipsCount = array.getInt(R.styleable.FoldingCell_fc_additionalFlipsCount, DEF_ADDITIONAL_FLIPS);
        } finally {
            array.recycle();
        }
    }
