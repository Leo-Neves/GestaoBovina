...
import br.agr.terras.materialdroid.ProgressView;
...
public class CircularProgressDrawable extends Drawable implements Animatable {
    ...
    public void applyStyle(Context context, int resId){
        ...
        for(int i = 0, count = a.getIndexCount(); i < count; i++){
            ...
            else if(attr == R.styleable.CircularProgressDrawable_cpd_progress)
                setProgress(a.getFloat(attr, 0));
            else if(attr == R.styleable.CircularProgressDrawable_cpd_secondaryProgress)
            ...
            else if(attr == R.styleable.CircularProgressDrawable_cpd_progressMode)
    ...
    public static class Builder{
        ...
        public Builder(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes){
            ...
            progressPercent(a.getFloat(R.styleable.CircularProgressDrawable_cpd_progress, 0));
            secondaryProgressPercent(a.getFloat(R.styleable.CircularProgressDrawable_cpd_secondaryProgress, 0));
            ...
            progressMode(a.getInteger(R.styleable.CircularProgressDrawable_cpd_progressMode, ProgressView.MODE_INDETERMINATE));
