...
public class LinearProgressDrawable extends Drawable implements Animatable {
    ...
    public void applyStyle(Context context, int resId){
        ...
        for(int i = 0, count = a.getIndexCount(); i < count; i++){
            ...
            if(attr == R.styleable.LinearProgressDrawable_lpd_progress)
                setProgress(a.getFloat(attr, 0));
            else if(attr == R.styleable.LinearProgressDrawable_lpd_secondaryProgress)
            ...
            else if(attr == R.styleable.LinearProgressDrawable_lpd_progressMode)
    ...
    public static class Builder{
        ...
        public Builder(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes){
            ...
            progressPercent(a.getFloat(R.styleable.LinearProgressDrawable_lpd_progress, 0));
            secondaryProgressPercent(a.getFloat(R.styleable.LinearProgressDrawable_lpd_secondaryProgress, 0));
            ...
            progressMode(a.getInteger(R.styleable.LinearProgressDrawable_lpd_progressMode, ProgressView.MODE_INDETERMINATE));
