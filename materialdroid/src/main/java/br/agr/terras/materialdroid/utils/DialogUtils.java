...
public class DialogUtils {
    ...
    /**
     * Returns a color associated com a particular resource ID
     * <p/>
    ...
    public static void showKeyboard(@NonNull final DialogInterface di, @NonNull final Dialog.Builder builder) {
    ...
    public static void hideKeyboard(@NonNull final DialogInterface di, @NonNull final Dialog.Builder builder) {
        final Dialog dialog = (Dialog) di;
        if (dialog.getInputEditText() == null) return;
        InputMethodManager imm = (InputMethodManager) builder.getContext().getSystemService(Context.INPUT_METHOD_SERVICE);
        if (imm != null) {
