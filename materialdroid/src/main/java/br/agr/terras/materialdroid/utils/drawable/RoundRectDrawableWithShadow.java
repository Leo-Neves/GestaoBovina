...
public class RoundRectDrawableWithShadow extends Drawable {
    ...
    * */
    ...
    private int alphaStart = 55;
    private int alphaEnd = 3;
    ...
    public void setColorShadow(int colorShadow) {
        ...
        mShadowStartColor = ColorUtils.setAlphaComponent(colorShadow, alphaStart);
        mShadowEndColor = ColorUtils.setAlphaComponent(colorShadow, alphaEnd);
        invalidateSelf();
    }
