...
public class PesquisaView extends EditText {
    ...
    public PesquisaView(Context context) {
        super(context);
        init();
    }

    public PesquisaView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }

    public PesquisaView(Context context, AttributeSet attrs, int defStyle) {
