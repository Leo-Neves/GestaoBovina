package br.agr.terras.materialdroid.utils.searchview.view;
...
import br.agr.terras.materialdroid.utils.searchview.MenuPopupHelper;
...
public class MenuView extends LinearLayout {
    ...
    private ImageView createActionView() {
        return (ImageView) LayoutInflater.from(getContext()).inflate(R.layout.search_action_item_layout, this, false);
    }

    private ImageView getOverflowActionView() {
        return (ImageView) LayoutInflater.from(getContext()).inflate(R.layout.search_overflow_action_item_layout, this, false);
    }
