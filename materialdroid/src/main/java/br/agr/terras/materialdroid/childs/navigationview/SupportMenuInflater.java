...
public class SupportMenuInflater extends MenuInflater {
    ...
    private void parseMenu(XmlPullParser parser, AttributeSet attrs, Menu menu) throws XmlPullParserException, IOException {
        MenuState menuState = new SupportMenuInflater.MenuState(menu);
    ...
    private class MenuState {
        ...
        public void readItem(AttributeSet attrs) {
            ...
            if (hasActionProvider && this.itemActionViewLayout == 0 && this.itemActionViewClassName == null) {
                this.itemActionProvider = (ActionProvider)this.newInstance(this.itemActionProviderClassName, android.support.v7.view.SupportMenuInflater.ACTION_PROVIDER_CONSTRUCTOR_SIGNATURE, android.support.v7.view.SupportMenuInflater.this.mActionProviderConstructorArguments);
            } else {
        ...
        private void setItem(MenuItem item) {
            ...
            if (this.itemListenerMethodName != null) {
                if (android.support.v7.view.SupportMenuInflater.this.mContext.isRestricted()) {
                    throw new IllegalStateException("The android:onClick attribute cannot be used within a restricted context");
                }

                item.setOnMenuItemClickListener(new android.support.v7.view.SupportMenuInflater.InflatedOnMenuItemClickListener(android.support.v7.view.SupportMenuInflater.this.getRealOwner(), this.itemListenerMethodName));
            }
            ...
            if (this.itemActionViewClassName != null) {
                View actionView = (View)this.newInstance(this.itemActionViewClassName, android.support.v7.view.SupportMenuInflater.ACTION_VIEW_CONSTRUCTOR_SIGNATURE, android.support.v7.view.SupportMenuInflater.this.mActionViewConstructorArguments);
        ...
        private <T> T newInstance(String className, Class<?>[] constructorSignature, Object[] arguments) {
            try {
                Class<?> clazz = android.support.v7.view.SupportMenuInflater.this.mContext.getClassLoader().loadClass(className);
