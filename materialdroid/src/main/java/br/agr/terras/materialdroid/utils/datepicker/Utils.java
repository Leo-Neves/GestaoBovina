...
package br.agr.terras.materialdroid.utils.datepicker;
...
public class Utils {
    ...
    public static int getAccentColorFromThemeIfAvailable(Context context) {
        ...
        return ContextCompat.getColor(context, br.agr.terras.materialdroid.R.color.mdtp_accent_color);
    }
    ...
    public static boolean isDarkTheme(Context context, boolean current) {
        return resolveBoolean(context, br.agr.terras.materialdroid.R.attr.mdtp_theme_dark, current);
    }
