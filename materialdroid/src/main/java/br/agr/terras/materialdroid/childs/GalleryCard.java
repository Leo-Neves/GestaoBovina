...
public class GalleryCard extends LinearLayout {
    ...
    public interface OnPageChangeListener {
         ...
         */
        void onPageScrolled(GalleryCard v, int position,
         ...
         * 动画并不一定完成
         */
        void onPageSelected(GalleryCard v, int prevPosition,
                            int curPosition);

        /**
         * 当动画结束后，新页面被选中时调用
         */
        void onPageSelectedAfterAnimation(GalleryCard v,
         ...
         *
         * @param state 滑动状态.
         * @see GalleryCard#SCROLL_STATE_IDLE
         * @see GalleryCard#SCROLL_STATE_DRAGGING
         * @see GalleryCard#SCROLL_STATE_SETTLING
         */
        void onPageScrollStateChanged(GalleryCard v, int state);
