...
public class TabPageIndicator extends HorizontalScrollView implements ViewPager.OnPageChangeListener, View.OnClickListener, ThemeManager.OnThemeChangedListener{
    ...
    /**
     * Set the ViewPager associate com this indicator view.
    ...
    /**
     * Set the ViewPager associate com this indicator view and the current position;
     * @param view The ViewPager view.
                ...
                if(widthMode != MeasureSpec.EXACTLY){
                    ...
                    if(widthMode == MeasureSpec.UNSPECIFIED || width < widthSize)
                        ...
                        for (int i = 0; i < count; i++) {
                            View child = getChildAt(i);
                            if(i != count - 1)
                                child.measure(MeasureSpec.makeMeasureSpec(Math.abs(childWidth), MeasureSpec.EXACTLY), heightMeasureSpec);
                            else
