 ...
 */
public class SwitchAlone extends View implements Checkable, ThemeManager.OnThemeChangedListener {
    ...
    public interface OnCheckedChangeListener{
         ...
         * @param view The SwitchAlone view.
    ...
    public SwitchAlone(Context context) {
        super(context);

        init(context, null, 0, 0);
    }

    public SwitchAlone(Context context, AttributeSet attrs) {
        super(context, attrs);

        init(context, attrs, 0, 0);
    }

    public SwitchAlone(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    public SwitchAlone(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
    ...
    public void setColor(int color){
        ...
        mThumbColors = new ColorStateList(states, colorsThumb);

        float h = ColorUtil.hue(color);
        float s = ColorUtil.saturation(color);
        float b = ColorUtil.brightness(color);
        int colorLight = ColorUtil.HSBtoColor(h,s-30,b+5);
        Log.i("SwitchAlone","Color normal: "+color);
        Log.i("SwitchAlone","Color light: "+colorLight);

        int[] colorsTrack = new int[]{
                ColorUtil.getColor(ThemeUtil.colorControlNormal(getContext(), 0xFF000000), 0.5f),
                color,
        };

        mTrackColors = new ColorStateList(states, colorsTrack);
        buildShadow();
        invalidate();
    }
    ...
    /**
     * Change the checked state of this SwitchAlone immediately without showing animation.
     * @param checked The checked state.
     */
    ...
    static class SavedState extends BaseSavedState {
        ...
        /**
         * Constructor called from {@link SwitchAlone#onSaveInstanceState()}
         */
