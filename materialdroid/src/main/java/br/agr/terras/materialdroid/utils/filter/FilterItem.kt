...
class FilterItem : FrameLayout, Serializable {
    ...
    var fullSize: Int = 0
    var listener: FilterItemListener? = null

    private var mText: String? = null
    private var mStrokeWidth: Int = ViewGroupExtensions.dpToPx(this, 1.25f)
    ...
    public override fun onInterceptTouchEvent(ev: MotionEvent?): Boolean = when (parent) {
