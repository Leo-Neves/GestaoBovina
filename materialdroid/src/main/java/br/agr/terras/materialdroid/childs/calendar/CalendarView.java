...
import br.agr.terras.materialdroid.utils.calendar.DayItem;
import br.agr.terras.materialdroid.utils.calendar.Events;
import br.agr.terras.materialdroid.utils.calendar.WeekItem;
...
public class CalendarView extends LinearLayout {
    ...
    public void init(CalendarManager calendarManager, int dayTextColor, int currentDayTextColor, int pastDayTextColor, int monthTextColor) {
        ...
        setUpAdapter(today, weeks, dayTextColor, currentDayTextColor, pastDayTextColor, monthTextColor);
     ...
     */
    private void setUpAdapter(Calendar today, List<WeekItem> weeks, int dayTextColor, int currentDayTextColor, int pastDayTextColor, int monthTextColor) {
        if (mWeeksAdapter == null) {
            Log.d(LOG_TAG, "Setting adapter com today's calendar: " + today.toString());
            mWeeksAdapter = new WeeksAdapter(getContext(), today, dayTextColor, currentDayTextColor, pastDayTextColor, monthTextColor);
