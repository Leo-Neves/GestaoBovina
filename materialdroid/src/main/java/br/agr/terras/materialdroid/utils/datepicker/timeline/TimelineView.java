package br.agr.terras.materialdroid.utils.datepicker.timeline;
...
import br.agr.terras.materialdroid.DateTimeline;
...
public class TimelineView extends RecyclerView {
    ...
    private DateTimeline.OnDateSelectedListener onDateSelectedListener;
    ...
    public void setOnDateSelectedListener(DateTimeline.OnDateSelectedListener onDateSelectedListener) {
        this.onDateSelectedListener = onDateSelectedListener;
    }

    public DateTimeline.OnDateSelectedListener getOnDateSelectedListener() {
    ...
    private class TimelineAdapter extends Adapter<TimelineViewHolder> {
        ...
        public TimelineViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            final View view = LayoutInflater.from(parent.getContext())
                    .inflate(R.layout.datepicker_item_day, parent, false);
    ...
    private class TimelineViewHolder extends ViewHolder {
