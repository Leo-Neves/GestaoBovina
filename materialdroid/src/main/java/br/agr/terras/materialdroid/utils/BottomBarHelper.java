...
public class BottomBarHelper {
    ...
    /**
     * Update top margin com animation
     */
    ...
    /**
     * Update bottom margin com animation
     */
    ...
    /**
     * Update left margin com animation
     */
    ...
    /**
     * Update text size com animation
     */
    ...
    /**
     * Update text color com animation
     */
    ...
    /**
     * Update image view color com animation
     */
    public static void updateDrawableColor(final Context context, final Drawable drawable,
        ...
        colorAnimation.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
            @Override
            public void onAnimationUpdate(ValueAnimator animator) {
                imageView.setImageDrawable(BottomBarHelper.getTintDrawable(drawable,
