...
import br.agr.terras.materialdroid.animations.BottomBarNavigationBehavior;
import br.agr.terras.materialdroid.childs.BottomBarNavigationItem;
import br.agr.terras.materialdroid.parents.CoordinatorLayout;
import br.agr.terras.materialdroid.utils.BottomBarHelper;
...
public class BottomBar extends FrameLayout {
    ...
    private ArrayList<BottomBarNavigationItem> items = new ArrayList<>();
    private ArrayList<View> views = new ArrayList<>();
    private BottomBarNavigationBehavior<BottomBar> bottomNavigationBehavior;
    ...
    private void createClassicItems(LinearLayout linearLayout) {
        ...
        for (int i = 0; i < items.size(); i++) {
            ...
            BottomBarNavigationItem item = items.get(itemIndex);
            ...
            icon.setImageDrawable(BottomBarHelper.getTintDrawable(items.get(i).getDrawable(context),
    ...
    private void updateItems(final int itemIndex, boolean useCallback) {
        ...
        for (int i = 0; i < views.size(); i++) {
            ...
            if (i == itemIndex) {
                ...
                BottomBarHelper.updateTopMargin(icon, inactiveMarginTop, activeMarginTop);
                BottomBarHelper.updateLeftMargin(notification, notificationInactiveMarginLeft, notificationActiveMarginLeft);
                BottomBarHelper.updateTextColor(title, itemInactiveColor, itemActiveColor);
                BottomBarHelper.updateTextSize(title, inactiveSize, activeSize);
                BottomBarHelper.updateDrawableColor(context, items.get(itemIndex).getDrawable(context), icon,
                ...
                if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP && colored) {
                    ...
                    BottomBarHelper.updateViewBackgroundColor(this, currentColor,
                ...
                BottomBarHelper.updateTopMargin(icon, activeMarginTop, inactiveMarginTop);
                BottomBarHelper.updateLeftMargin(notification, notificationActiveMarginLeft, notificationInactiveMarginLeft);
                BottomBarHelper.updateTextColor(title, itemActiveColor, itemInactiveColor);
                BottomBarHelper.updateTextSize(title, activeSize, inactiveSize);
                BottomBarHelper.updateDrawableColor(context, items.get(currentItem).getDrawable(context), icon,
    ...
    private void updateSmallItems(final int itemIndex, boolean useCallback) {
        ...
        for (int i = 0; i < views.size(); i++) {
            ...
            if (i == itemIndex) {
                ...
                BottomBarHelper.updateTopMargin(icon, inactiveMargin, activeMarginTop);
                BottomBarHelper.updateLeftMargin(notification, notificationInactiveMarginLeft, notificationActiveMarginLeft);
                BottomBarHelper.updateTextColor(title, itemInactiveColor, itemActiveColor);
                BottomBarHelper.updateAlpha(title, 0, 1);
                BottomBarHelper.updateWidth(container, notSelectedItemWidth, selectedItemWidth);
                BottomBarHelper.updateDrawableColor(context, items.get(itemIndex).getDrawable(context), icon,
                        itemInactiveColor, itemActiveColor, forceTint);
                ...
                BottomBarHelper.updateTopMargin(icon, activeMarginTop, inactiveMargin);
                BottomBarHelper.updateLeftMargin(notification, notificationActiveMarginLeft, notificationInactiveMarginLeft);
                BottomBarHelper.updateTextColor(title, itemActiveColor, itemInactiveColor);
                BottomBarHelper.updateAlpha(title, 1, 0);
                BottomBarHelper.updateWidth(container, selectedItemWidth, notSelectedItemWidth);
                BottomBarHelper.updateDrawableColor(context, items.get(currentItem).getDrawable(context), icon,
                        itemActiveColor, itemInactiveColor, forceTint);
        ...
        for (int i = 0; i < views.size(); i++) {
            ...
            if (updateStyle) {
                ...
                if (notificationBackgroundDrawable != null) {
                    ...
                    Drawable defautlDrawable = ContextCompat.getDrawable(context, R.drawable.bottom_bar_notification_background);
                    if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.JELLY_BEAN) {
                        notification.setBackground(BottomBarHelper.getTintDrawable(defautlDrawable,
                                notificationBackgroundColor, forceTint));
                    } else {
                        notification.setBackgroundDrawable(BottomBarHelper.getTintDrawable(defautlDrawable,
                                notificationBackgroundColor, forceTint));
                    }
     ...
     * Add an item
     */
    public void addItem(BottomBarNavigationItem item) {
     ...
     * Add all items
     */
    public void addItems(List<BottomBarNavigationItem> items) {
     ...
     */
    public BottomBarNavigationItem getItem(int position) {
    ...
    public void setBehaviorTranslationEnabled(boolean behaviorTranslationEnabled) {
        ...
        if (getParent() instanceof CoordinatorLayout) {
            ...
            if (bottomNavigationBehavior == null) {
                bottomNavigationBehavior = new BottomBarNavigationBehavior<>(behaviorTranslationEnabled);
            } else {
    ...
    /**
     * Hide Bottom Navigation com animation
     */
    ...
    /**
     * Hide Bottom Navigation com or without animation
     *
    ...
    /**
     * Restore Bottom Navigation com animation
     */
    ...
    /**
     * Restore Bottom Navigation com or without animation
     *
     * @param withAnimation Boolean
     */
    ...
    /**
     * Return if the tint should be forced (com setColorFilter)
     *
     * @return Boolean
     */
     ...
     * If forceTint = true, the tint is made com drawable.setColorFilter(color, PorterDuff.Mode.SRC_IN);
     *
