...
import br.agr.terras.materialdroid.parents.Button;
...
//					textView.setLayoutParams(params);textColor
            ...
            boolean textAllCaps = attrs.getAttributeBooleanValue(ANDROIDXML,"textAllCaps",false);
            textButton.setAllCaps(textAllCaps);
            if(textColor != -1){
