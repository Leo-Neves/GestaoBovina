...
import br.agr.terras.materialdroid.childs.RippleDrawable;
...
import br.agr.terras.materialdroid.utils.drawable.LineMorphingDrawable;
import br.agr.terras.materialdroid.utils.drawable.OvalShadowDrawable;

public class FloatingButton extends View implements ThemeManager.OnThemeChangedListener {
    ...
    public static FloatingButton make(Context context, int resId){
        return new FloatingButton(context, null, resId);
    }
    ...
    protected void applyStyle(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        ...
        for(int i = 0, count = a.getIndexCount(); i < count; i++){
            ...
            else if(attr == R.styleable.FloatingActionButton_fab_elevationCompat)
                elevation = a.getDimensionPixelSize(attr, 0);
            else if(attr == R.styleable.FloatingActionButton_fab_colorNormal)
     ...
     * @param gravity The gravity apply com this button.
     *
     * @see Gravity
     */
     ...
     * Show this button at the specific location. If this button isn't attached to any parent view yet,
     * it will be add to activity's root view. If not, it will just update the location.
     * @param parent The parent view. Should be {@link FrameLayout} or { RelativeLayout}
     * @param x The x value of anchor point.
     * @param y The y value of anchor point.
     * @param gravity The gravity apply com this button.
     *
    ...
    public void updateLocation(int x, int y, int gravity){
        if(getParent() != null)
            ...
            Log.v(FloatingButton.class.getSimpleName(), "updateLocation() is called without parent");
    }
    ...
    private void setLeftMargin(ViewGroup.LayoutParams params, int value){
        if(params instanceof ViewGroup.MarginLayoutParams)
            ...
            Log.v(FloatingButton.class.getSimpleName(), "cannot recognize LayoutParams: " + params);
    }
    ...
    static class SavedState extends BaseSavedState {
        ...
        /**
         * Constructor called from {Slider#onSaveInstanceState()}
         */
        ...
        public String toString() {
            return "FloatingButton.SavedState{"
    ...
    class SwitchIconAnimator implements Runnable{
        ...
        public boolean startAnimation(Drawable icon) {
            ...
            float half = mIconSize / 2f;
            mIcon.setBounds((int)(mBackground.getCenterX() - half), (int)(mBackground.getCenterY() - half), (int)(mBackground.getCenterX() + half), (int)(mBackground.getCenterY() + half));
            mIcon.setCallback(FloatingButton.this);
